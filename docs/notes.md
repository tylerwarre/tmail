...
`C:\Users\M83393\libs\openssl-3.6.1\apps\openssl.exe req -CA .\certs\ca-cert.pem -CAkey .\certs\ca-key.pem -newkey rsa:4096 -keyout .\certs\ca-key.pem -out .\certs\ca-cert.pem -config .\openssl.cnf`
